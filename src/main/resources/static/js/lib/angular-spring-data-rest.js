        ...
        $get: ["$injector", function ($injector) {
            ...
            function resourcesFunction(url, paramDefaults, actions, options) {
                if (config.resourcesFunction == undefined) {
                    return $injector.get("$resource")(url + '/:id', paramDefaults, actions, options);//Added id template
                } else {
                ...
                if (config.fetchFunction == undefined) {
                    $injector.get("$http").get(url)
                        .success(function (responseData) {
                            ...
                            data[key] = data[key][config.embeddedNewKey] ? data[key][config.embeddedNewKey] : data[key];
